                    ...
                    <div class="service-item rounded d-flex flex-column h-100">
                        ...
                        <div class="service-text rounded p-5">
                            <div class="btn-square rounded-circle mx-auto mb-3">
                                <img class="img-fluid" src="img/icon/icon-{{ $loop->index + 3 }}.png" alt="Icon">
                            </div>
                            <h4 class="mb-3">{{ $provider->name }}</h4>
                            <p class="mb-4">{{ $provider->description ?? 'Erat ipsum justo amet duo et elitr dolor, est duo duo eos lorem sed diam stet diam sed stet.' }}</p>
                            <a class="btn btn-sm" href="{{ route('providers.show', $provider->id) }}"><i class="fa fa-plus text-primary me-2"></i>Read More</a>
                        </div>
                    </div>
                </div>
            @endforeach
